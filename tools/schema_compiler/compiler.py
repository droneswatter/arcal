...
inline {{ type.cxx_name }}& {{ type.cxx_name }}::create(uci::base::AbstractServiceBusConnection*) {
    return *new arcal::type::{{ type.cxx_name }}Impl{};
}

inline {{ type.cxx_name }}& {{ type.cxx_name }}::create(const {{ type.cxx_name }}& rhs,
...
inline void {{ type.cxx_name }}::destroy({{ type.cxx_name }}& accessor) {
